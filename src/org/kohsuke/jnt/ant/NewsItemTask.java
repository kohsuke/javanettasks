/*
 * $Id: NewsItemTask.java 53 2003-12-17 01:29:18Z ryan_shoemaker $
 *
...
public class NewsItemTask extends AbstractJavaNetTaskForProject {
    ...
    protected void run(JNProject project)
        ...
        log("submitting news item", Project.MSG_INFO);
        project.createNewsItem()
            .submitNewsItemData(date, headline, body, imageUrl, articleUrl);
    }
